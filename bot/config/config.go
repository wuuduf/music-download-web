...
func setDefaults(v *viper.Viper) {
	...
	v.SetDefault("WebStemEnabled", false)
	v.SetDefault("WebStemPython", "/opt/musicweb/stem-venv/bin/python")
	v.SetDefault("WebStemScript", "./stem-worker/worker.py")
	v.SetDefault("WebStemWorkDir", "./cache/stems")
	v.SetDefault("WebStemMaxConcurrent", 1)
	v.SetDefault("WebStemTTLHours", 24)
	v.SetDefault("WebStemDemucsModel", "htdemucs_6s")
	v.SetDefault("WebStemDevice", "auto")
	v.SetDefault("WebStemShifts", 1)
	v.SetDefault("WebStemOverlap", "0.25")
	v.SetDefault("WebStemRefinementEnabled", false)
	v.SetDefault("WebStemSeparatorBinary", "audio-separator")
	v.SetDefault("WebStemVocalModel", "model_mel_band_roformer_ep_3005_sdr_11.4360.ckpt")
	v.SetDefault("WebStemBackingPreset", "karaoke")
	v.SetDefault("WebStemPianoModel", "")
	v.SetDefault("WebStemGuitarModel", "")
